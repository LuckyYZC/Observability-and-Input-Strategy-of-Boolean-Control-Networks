...
\end{enumerate}
 ...
 From the four notions of observability, we can see that the first and second one determine $\mathsf{s}(0)$ by taking the determining procedure multiple times, and the third and fourth one is by taking the determining procedure once. %And the second observability is the necessary and sufficient condition of determining $\mathsf{s}(0)$ by taking the determining procedure once. 
 In this paper, we propose an observability named online observability to address the necessary and sufficient condition of determining $\mathsf{s}(0)$ by taking the determining procedure once.
\begin{itemize}
