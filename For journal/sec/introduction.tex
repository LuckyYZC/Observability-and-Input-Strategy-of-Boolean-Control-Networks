...
\end{comment}
Although, four existing observability can help us study some information about \State$^{i}(0)$ we need. \ly{But when the decision procedure can do at most once, only third and fourth in above observability  can  determine the \State$^{i}(0)$ of \BCNs.}%{\color{blue}{Not clear}} And conditions of third and fourth in above observability are strong.
