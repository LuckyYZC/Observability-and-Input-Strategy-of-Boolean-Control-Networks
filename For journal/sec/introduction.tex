...
\tl{you mean naturally there is a procedure which is described as follows?}
...
%Informly, the procedure of our  online observability as follows. 
 ...
 \tl{can you make this a proper algorithm?}
\begin{description}
...
%{\color{red} (13)} 
Inspired by this procedure, we propose a new notion of observability named online observability to address the necessary and sufficient condition of determining $\mathsf{s}(0)$ by taking the determining procedure once. It states that a \BCN\ $\BB$ is observable if the previously mentioned procedure can be completed {\bf definitely}. Its formal definitions will be presented in Section~\ref{sec:online}. 
