...
\label{sec:deter}
To  determine  online observability of \BCN s, one needs to determine $\Ks(\Ded\left(\Delta_N,\varepsilon,\mathsf{o}^{j}(0)\right))$ for every non-empty $\Ded(\Delta_N,\varepsilon, \mathsf{o}^{j}(0))$. 
