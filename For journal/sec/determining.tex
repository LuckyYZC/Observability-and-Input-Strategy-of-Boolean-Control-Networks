...
\[\Ded\left(\mathsf{S}^i,\varepsilon, \mathsf{o}^j\right)\ne \emptyset,\]
...
\item Secondly, we check the online observability of the \BCN\ after $2k+2$ layer of the supertree was built for every $k\ge0$. If the \BCN\ is online observable, then we stop building the supertree and delete the uncertain branches. 
