...
\item  $\mathcal{L}:\mathcal{E}\mapsto 2^{\mathcal{I}}=(\mathsf{S}_1,\mathsf{S}_2)\mapsto\{\mathsf{i}\in \Ri(\mathsf{S}_1)|\mathsf{S}_2\in\{\Ded(\mathsf{S}_1,\mathsf{i},\mathsf{o})|\mathsf{o}\in  \mathcal{O}\}\}$.
 \end{itemize}
\end{definition}
