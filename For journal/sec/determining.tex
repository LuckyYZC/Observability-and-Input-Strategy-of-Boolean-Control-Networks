...
\begin{itemize}
\item  Because, once we find a $\mathsf{S}$ that $\mathsf{S}\notin \mathcal{V}$, i.e. $\Ks(\mathsf{S})= \infty$, and as there exists $\mathsf{o}\in \mathcal{O}$, such that $\mathsf{S}\subseteq \Ded(\mathcal{S}_\BB,\varepsilon, \mathsf{o})$, then we have $\Ks(\Ded(\mathcal{S}_\BB,\varepsilon, \mathsf{o}))= \infty$ %, i.e. $\Ded(\mathcal{S}_\BB,\varepsilon, \mathsf{o}(0))\notin \mathcal{V}$
