...
Therefore we have this \BCN\ is the online observable, we can determine the initial state of it. And this \BCN\ is controllable, thus it is identifiable too.  %Thus with the online observability we can research the \BCNs\ better.
\label{exa:10}
\end{example}  
