...
Based on the new algorithm mentioned in {\em Section \ref{sec:intro}}, we propose the online observability, viz., a \BCN\ is online observable if its $\mathsf{s}(0)$ can be determined by this algorithm. And we call the observability defined in {\em Section \ref{sec:pre}} offline observability.
