...
As we mentioned in {\em Section \ref{sec:pre}}, we can use the third existing observability to determine the initial state of \BCN. \ly{But for a \BCN, there has to exist an input sequence that determines its initial state $\mathsf{s}(0)$. }
