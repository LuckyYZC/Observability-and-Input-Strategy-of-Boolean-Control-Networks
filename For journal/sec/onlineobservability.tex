...
Based on this procedure, we propose the online observability, viz., a \BCN\ is observable if the procedure to determine $\mathsf{s}(0)$ would terminates.  \tl{do you mean that the procedure terminates?} \gs{Yes} 
