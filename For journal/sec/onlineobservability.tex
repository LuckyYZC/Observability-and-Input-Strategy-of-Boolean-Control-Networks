...
Based on this procedure, we propose the online observability, viz., a \BCN\ is observable if the previously mentioned procedure to determine $\mathsf{s}(0)$ can be completed {\bf definitely}.  \tl{do you mean that the procedure terminates?}
...
\tl{check whether this is what you want!?}
\end{definition}
