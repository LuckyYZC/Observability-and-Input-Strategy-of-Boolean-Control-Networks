...
If $k=0$, we have  \[\mathsf{S}^{1} = \mathsf{S}^{2}.\] Therefore, we have $\mathsf{S}^{1}$ is $0$-step determinable, thus we have the {\em Lemma \ref{lemm:1}} is right when $k=0$.
 ...
 \item  for each \[\mathsf{o}^{j}\in \Delta_Q\] such that \[\Ded(\mathsf{S}^{2},\mathsf{i}^{i},\mathsf{o}^{j})\neq \emptyset,\] the $\Ded(\mathsf{S}^{2},\mathsf{i}^{i},\mathsf{o}^{j})$ is $k'$-step determinable, where ${k'}<(p+1)$.
 \end{itemize}
 ...
 \item  for each \[\mathsf{o}^{j}\in \Delta_Q\] such that \[\Ded(\mathsf{S}^{1},\mathsf{i}^{i},\mathsf{o}^{j})\neq \emptyset,\] the \[\Ded(\mathsf{S}^{1},\mathsf{i}^{i}(t),\mathsf{o}^{j})\subseteq \Ded(\mathsf{S}^{2},\mathsf{i}^{i},\mathsf{o}^{j})\] is  $k'$-step determinable, where ${k'}<(p+1)$.
 \end{itemize}  Then we have the $\mathsf{S}^{1}$ is $(p+1)$-step determinable. 
