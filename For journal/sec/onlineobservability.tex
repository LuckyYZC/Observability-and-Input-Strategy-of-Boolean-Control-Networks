...
For $k>0$, a set of states $\mathsf{S}(t)$ is $k$-step determinable
 ...
 \item  for each $\mathsf{o}^{j}(t)\in \Delta_Q$ such that $|\Ded\left(\mathsf{S}(t),\mathsf{i}^{i}(t),\mathsf{o}^{j}(t)\right)|\neq 0$, there exists a ${k'}<k$ such that $\Ded\left(\mathsf{S}(t),\mathsf{i}^{i}(t),\mathsf{o}^{j}(t)\right)$ is $k'$-step determinable.
 \end{itemize}
...
\begin{itemize}
\item When $k=0$, for $\mathsf{S}(t)$ we can determine the state $\mathsf{s^{i}}(t)$ at time step $t$ for every $\mathsf{s}^{i}(t)\in \mathsf{S}(t)$. Thus, we have that $|\mathsf{S}(t)|=1$. Only in this case we can determine the state $\mathsf{s}(t)$ at time step $t$. So we have the definition is right.
...
\begin{itemize}
\item $|\Ded\left(\mathsf{S}(t),\mathsf{i}^{i}(t),\varepsilon\right)|=|\mathsf{S}(t)|$, only in this case we can determine the state $\mathsf{s^{i}}(t)$ at time step $t+1$ for every $\mathsf{s}^{i}(t)\in \mathsf{S}(t)$ when we can determine the state $\mathsf{s^{i}}(t+1)$ at time step $t+1$ for every $\mathsf{s}^{i}(t+1)\in \Ded\left(\mathsf{S}(t),\mathsf{i}^{i}(t),\varepsilon\right)$;
\item And we can determine the state $\mathsf{s^{i}}(t+1)$ at time step $t+1$ for every $\mathsf{s}^{i}(t+1)\in \Ded\left(\mathsf{S}(t),\mathsf{i}^{i}(t),\varepsilon\right)$. To guarantee this we have for each $\mathsf{o}^{j}(t)\in \Delta_Q$ such that $|\Ded\left(\mathsf{S}(t),\mathsf{i}^{i}(t),\mathsf{o}^{j}(t)\right)|=1\neq 0$, there exists a ${k'}=0<k=1$ such that $\Ded\left(\mathsf{S}(t),\mathsf{i}^{i}(t),\mathsf{o}^{j}(t)\right)$ is $k'$-step determinable.
 \end{itemize}
So we have the definition is right.
...
\begin{itemize}
\item $|\Ded\left(\mathsf{S}(t),\mathsf{i}^{i}(t),\varepsilon\right)|=|\mathsf{S}(t)|$, only in this case we can determine the state $\mathsf{s^{i}}(t)$ at time step $t+p+1$ for every $\mathsf{s}^{i}(t)\in \mathsf{S}(t)$ when we can determine the state $\mathsf{s^{i}}(t+1)$ at time step $t+p+1$ for every $\mathsf{s}^{i}(t+1)\in \Ded\left(\mathsf{S}(t),\mathsf{i}^{i}(t),\varepsilon\right)$;
\item And we can determine the state $\mathsf{s^{i}}(t+1)$ at time step $t+p+1$ for every $\mathsf{s}^{i}(t+1)\in \Ded\left(\mathsf{S}(t),\mathsf{i}^{i}(t),\varepsilon\right)$. To guarantee this we have for each $\mathsf{o}^{j}(t)\in \Delta_Q$ such that $|\Ded\left(\mathsf{S}(t),\mathsf{i}^{i}(t),\mathsf{o}^{j}(t)\right)|\neq 0$, there exists a ${k'}<k$ such that $\Ded\left(\mathsf{S}(t),\mathsf{i}^{i}(t),\mathsf{o}^{j}(t)\right)$ is $k'$-step determinable.
 \end{itemize}
So we have the definition is right.
 \end{itemize}
