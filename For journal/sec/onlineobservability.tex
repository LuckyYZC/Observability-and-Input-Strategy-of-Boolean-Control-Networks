...
%\end{definition}$\mathsf{S}\in 2^{\mathcal{S}_\BB}$, $\mathsf{i} \in (\mathcal{I}\cup\varepsilon)$, $\mathsf{o} \in (\mathcal{O}\cup\varepsilon)$, and
 ...
 \begin{definition}[$\mathsf{S}(t)$] Given $\mathsf{I}[t_k]=\mathsf{i}(0)\ldots\mathsf{i}(t_k)$ and $\mathsf{O}[t_k]= H^{[0,t_k]}(\mathsf{s}(0),\mathsf{I}[t_k])=\mathsf{o}(0)\ldots\mathsf{o}(t_k+1)$, %for every $t\le k$, 
	\[\mathsf{S}(t)=\left\{
\begin{array}{rcl}
