...
As the deduction function can only describe the deduction process of a \BCN\'s initial state at every time step. But we always need more than one time step to determine the initial state, thus we propose the $k$-step determinability to describe the whole process of determining a \BCN\'s initial state.
