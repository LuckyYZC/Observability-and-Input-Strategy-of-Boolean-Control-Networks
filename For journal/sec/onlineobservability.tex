...
We write \begin{equation*}\xi(\mathsf{i}, \mathsf{s}):= \left\{
\begin{array}{rcl}
\sigma( \mathsf{i}, \mathsf{s})      &      & {\mathsf{i}\neq \varepsilon}\\
\mathsf{s}       &      & {\mathsf{i}= \varepsilon}
\end{array} \right. 
\end{equation*}
where $\mathsf{i} \in (\mathcal{I}\cup\varepsilon)$, $\mathsf{s} \in (\mathcal{S})$ and $\varepsilon$ presents empty input.
...
%\end{split}
%\end{equation*}
where $\mathsf{S}\in 2^{\mathcal{S}_\BB}$, $\mathsf{i} \in (\mathcal{I}\cup\varepsilon)$, $\mathsf{o} \in (\mathcal{O}\cup\varepsilon)$, and $\varepsilon$ presents empty output.
