...
As we mentioned in {\em Section \ref{sec:pre}}, we can use the third existing observability to determine the initial state of \BCN. \ly{But for a \BCN, it is observable unless there exists an input sequence that determine its initial state $\mathsf{s}(0)$. }
