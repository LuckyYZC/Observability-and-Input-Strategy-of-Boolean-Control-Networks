...
When $|\mathsf{S}|=1$, 
$\Pv(\mathsf{S}, \mathsf{ i}^{i})=0$ for every $\mathsf{ i}^{i} \in \{\mathsf{ i}^{1},\mathsf{ i}^{2},\ldots, \mathsf{ i}^{p}\}$.  When $|\mathsf{S}|>1$, 
\begin{equation}
\begin{split}
...
When $|\mathsf{S}|=1$, 
$\Cv(\mathsf{S}, \mathsf{ i}^{i})=0$ for every  $\mathsf{ i}^{i} \in \{\mathsf{ i}^{1},\mathsf{ i}^{2},\ldots, \mathsf{ i}^{p}\}$.  When $|\mathsf{S}|>1$, 
\begin{equation}
\begin{split}
