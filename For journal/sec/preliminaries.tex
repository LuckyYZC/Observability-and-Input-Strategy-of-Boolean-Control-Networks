...
\begin{itemize}
  \item $\delta_{16}^0$ and $\delta_{16}^1$ can be distinguished by any $\mathsf{I}^{01}$ with the prefix $\delta_{4}^0$, $\delta_{4}^2 $ or $\delta_{4}^3$;
  \item $\delta_{16}^0$ and $\delta_{16}^2$ can be distinguished by any $\mathsf{I}^{02}$ with the prefix $\delta_{4}^1$, $\delta_{4}^2$ or $\delta_{4}^3$;
  \item $\delta_{16}^1$ and $\delta_{16}^2$ can be distinguished by any $\mathsf{I}^{12}$ with the prefix $\delta_{4}^1$, $\delta_{4}^2$ or $\delta_{4}^3$.
\end{itemize} 
