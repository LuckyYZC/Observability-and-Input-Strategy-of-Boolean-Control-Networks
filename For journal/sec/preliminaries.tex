...
Moreover, we use $\Delta_L=\{\delta_{2^{\ell}}^0,\ldots,\delta_{2^{\ell}}^{{2^{\ell}}-1}\}$, $\Delta_M=\{\delta_{2^m}^0,\ldots,\delta_{2^m}^{{2^m}-1}\}$ and $\Delta_N=\{\delta_{2^n}^0,\ldots,\delta_{2^n}^{{2^n}-1}\}$ to represent the sets of input, state, output, respectively.
