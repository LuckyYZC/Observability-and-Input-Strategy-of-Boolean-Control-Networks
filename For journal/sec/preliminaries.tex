...
%To introduce the observability, controllability and identifiability of \BCNs, 

Firstly, we define two functions to present the relations among the input sequence, state squence and output sequence~\cite{Zhang2016Observability}:
\begin{equation}
\begin{split}
