...
\label{equ:1}
\end{equation}
where $\mathsf{i}(t)$, $\mathsf{s}(t)$, and $\mathsf{o}(t)$ represent $(\mathsf{i}_1(t),\ldots \mathsf{i}_\ell(t))$, $(\mathsf{s}_1(t),\ldots \mathsf{s}_m(t))$ and $(\mathsf{o}_1(t),\ldots \mathsf{o}_n(t))$, respectively.
 \end{definition}
