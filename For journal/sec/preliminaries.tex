...
\item {\em Timed behavior}: each node $v\in I\cup S\cup O$ represents a Boolean variable, and we use 
 $i= (i_1,\ldots, i_\ell)$, $s= (s_1,\ldots, s_m)$ and $o= (o_1,\ldots, o_n)$ to denote the three Boolean variable vectors corresponding  to the input nodes, state nodes and output nodes. At any time $t\in \mathbb{T}$ during the execution 
