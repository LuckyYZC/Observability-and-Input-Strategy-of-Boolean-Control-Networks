...
To introduce the observability, controllability and identifiability of \BCNs, we first define two functions to present the relations among the input sequence, state squence and output sequence:
\begin{equation}
\begin{split}
