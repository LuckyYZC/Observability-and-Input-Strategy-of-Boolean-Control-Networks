...
\begin{definition}[Identifiability]
	...
	\begin{equation*}
		...
		\end{split}
	\end{equation*}
	can be determined by its input and output. 
\end{definition}

The controllability of \BCNs\ is defined as follows.
