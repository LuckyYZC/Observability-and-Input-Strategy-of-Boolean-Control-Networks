...
Therefore we have this \BCN\ does not satisfy the existing fourth observability. And we can not determine its initial state $\mathsf{s}(0)$ by third observability either. 
\label{exa:7}
\end{example}  
