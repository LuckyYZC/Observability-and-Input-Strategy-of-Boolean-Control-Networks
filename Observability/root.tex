...
\begin{definition}
	A {\bf BCN} is called online observable, if for every initial state $s_0 \in \Delta_N$ can be determined by the deciding input sequence and observing output sequence step by step in finite steps without presuppose the  initial state.
\end{definition}
