...
To this end, firstly we give the formal definition of online observability of {\em BCNs}. Secondly, we raise two algorithms to determine the online observability for {\em BCNs}, which stem from the formal definition of online observability. Finally, we introduce some applications of the online observability of {\em BCNs}, and the advantages of online observability compares with offline observabilities. %\rev{***Compare with offline observabilities****} 
